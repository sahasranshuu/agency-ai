...
import ThemeBtn from './ToggleBtn.jsx'
...
const Navbar = ({theme,setTheme}) => {
  ...
  return (
    <motion.div
      ...
      className="flex justify-between items-center px-4 sm:px-12 lg:px-24 x:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-edium bg-white/50 dark:bg-gray-900/70"
    >
      <img
